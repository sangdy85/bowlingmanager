        ...
        const cumulativeList = useMemo(() => {
            ...
            for (const round of sortedRounds) {
                ...
                const rankings = (round.participants || []).map((p: any) => {
                    ...
                    let gamesPlayed = 0;
                    const currentRoundHandicap = p.handicap ?? p.registration?.handicap ?? 0;
                        ...
                        <table className="excel-table">
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ width: '60px', minWidth: '60px' }}>참여</th>
                                    <th style={{ width: 'auto', minWidth: '65px' }}>누적</th>
                                    <th style={{ width: 'auto', minWidth: '65px' }}>입상</th>
                                </tr>
                            </thead>
                            <tbody>
