                ...
                <table className="w-full text-center text-sm table-fixed" style={{ borderCollapse: 'collapse' }}>
                    <thead className="bg-muted text-muted-foreground font-semibold">
                        ...
                        <tr>
                            ...
                            >
                                <div className="flex w-full items-center justify-center gap-2 py-3 relative">
                                    ...
                                    <span className="text-muted-foreground/40 text-lg font-light">|</span>
                                    <div className="px-4 flex items-center justify-center max-w-[200px]">
                                        <span className="font-normal text-sm truncate w-full text-center" title={memo}>
                                            {memo || '-'}
                                        </span>
                                    </div>
                                    <span className="text-muted-foreground/40 text-lg font-light">|</span>
                                    <div className="px-4 flex items-center justify-center">
                                        <span className="font-bold text-accent whitespace-nowrap text-lg">
                                            {dailyAvg || '0'}
                                        </span>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 p-2 rounded-full hover:bg-white/10 text-muted-foreground hover:text-green-500 transition-colors"
                                        title="엑셀 다운로드"
                                    >
