...
import { getUnifiedSeasonRanking, SEASON_COMPETITION_TYPES } from "@/lib/mobile-api/unified-season";
...
export async function GET(request: Request, context: RouteContext) {
    try {
        ...
        return mobileApiSuccess(await getUnifiedSeasonRanking(userId, teamId, {
