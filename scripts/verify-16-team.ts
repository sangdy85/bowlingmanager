...
const fmt = (m: any) => `${m.teamA}-${m.teamB}`;
...
// Check Round 12 (Index 11, User Round 13)
// Wait, my mapping logic:
// User Round 12 (Index 11 in written list) -> My Array Index 10.
// Let's re-verify specific index.
// User Image Round 12: 11-10...
// My Array Index 10: 11-10...
// So let's check Index 10.
const r12 = rounds[10];
